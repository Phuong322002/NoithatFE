...
const AdminProduct = () => {
  ...
  return (
    <div >
      ...
      <div style={{ marginTop: '20px', height: 'calc(100vh - 400px)' }}>
        <PerfectScrollbar>

          <TableComponent handleDelteMany={handleDelteManyProducts} columns={columns} isLoading={isPendingProducts} data={dataTable} onRow={(record, rowIndex) => {
            return {
              onClick: event => {
      ...
      <ModalComponent forceRender title="Create products" open={isModalOpen} onCancel={handleCancel} footer={null}>
